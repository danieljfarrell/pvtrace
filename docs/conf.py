...
latex_documents = [
    (master_doc, 'pvtrace.tex', 'pvtrace Documentation',
     'Daniel J Farrell', 'manual'),
]
...
man_pages = [
    (master_doc, 'pvtrace', 'pvtrace Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pvtrace', 'pvtrace Documentation',
     author, 'pvtrace', 'One line description of project.',
     'Miscellaneous'),
]
