...
class TestBox:
    ...
    def test_benchmark_box_is_on_surface(self, benchmark):
        benchmark(self.test_is_on_surface)
    
    def test_benchmark_box_is_on_surface_bad(self, benchmark):
        benchmark(self.test_is_on_surface_bad)

    def test_benchmark_box_contains(self, benchmark):
        benchmark(self.test_contains)

    def test_benchmark_box_intersection(self, benchmark):
        benchmark(self.test_intersection)

    def test_benchmark_box_normal(self, benchmark):
        benchmark(self.test_normal)

    def test_benchmark_is_entering(self, benchmark):
        benchmark(self.test_is_entering)
...
class TestBoxMesh:
    ...
    def test_benchmark_meshbox_is_on_surface(self, benchmark):
        benchmark(self.test_is_on_surface)
    
    def test_benchmark_meshbox_is_on_surface_bad(self, benchmark):
        benchmark(self.test_is_on_surface_bad)

    def test_benchmark_meshbox_contains(self, benchmark):
        benchmark(self.test_contains)

    def test_benchmark_meshbox_intersection(self, benchmark):
        benchmark(self.test_intersection)

    def test_benchmark_meshbox_normal(self, benchmark):
        benchmark(self.test_normal)

    def test_benchmark_meshbox_is_entering(self, benchmark):
        benchmark(self.test_is_entering)
